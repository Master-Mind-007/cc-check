...
|
*/
$config['botToken'] = "5403590360:AAFBcQo8xlGz3Jv2_5wgb8pcuwV9ousWeZI";
...
|--------------------------------------------------------------------------
|
| Change this to Admin's Numeric User ID1
| ID can be obtained from https://telegram.dog/username_to_id_bot
|so
*/
$config['adminID'] = "1191266989";
...
$config['db']['username'] =  "sql5507409";
$config['db']['password'] =  "8IGtluMV1H";
$config['db']['database'] =  "sql5507409";
